...
INSERT INTO anime(name, description, type, year, imageurl) values
    ('Fullmetal Alchemist',
        ...
        'action', 2003, 'https://i.imgur.com/SRJAfPL.jpg'),
    ('Fullmetal Alchemist Brotherhood',
        ...
        'action', 2009, 'https://i.imgur.com/Jq0ZC2L.jpg'),
    ('Haikyuu!',
        ...
        'deportes', 2014, 'https://i.imgur.com/4YthHz5.jpg'),
    ('Hunter X Hunter',
        ...
        'action', 2011, 'https://i.imgur.com/XtffOmW.jpg'),
    ('Black Clover',
        ...
        'action', 2017, 'https://i.imgur.com/KkUTG7b.jpg'),
    ('Jibaku Shonen Hanako-kun',
        ...
        'sobrenatural', 2020, 'https://i.imgur.com/D0t8pb3.jpg'),
    ('Cardcaptor Sakura',
        ...
        'magia', 2000, 'https://i.imgur.com/BCWduX3.jpg');
